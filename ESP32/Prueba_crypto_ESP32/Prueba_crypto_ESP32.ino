...
#define upLED 4
#define downLED 5
Adafruit_SH1106G display = Adafruit_SH1106G(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RESET);    //Create the display object

const char* ssid = "Arriba";                                            //Set your WiFi network name and password
const char* password = "0042185100";
...
const String url_btc = "https://api.cryptonator.com/api/ticker/btc-usd";
const String url_ada = "https://api.cryptonator.com/api/ticker/ada-usd";
const String url_sol = "https://api.cryptonator.com/api/ticker/sol-usd";
const String url_avax = "https://api.cryptonator.com/api/ticker/avax-usd";
const String url_dot = "https://api.cryptonator.com/api/ticker/dot-usd";
...
void setup() 
{
  ...
  display.begin(SCREEN_ADDRESS, true);               //Connect to the display

  display.clearDisplay();                                                   //Clear the display
  display.setTextColor(SH110X_WHITE);                                       
  display.drawBitmap(0, 0, bitcoinLogo, 128, 64, SH110X_WHITE);                    //Display bitmap from array
  display.display();
  delay(2000);
...
void loop() 
{
  ...
  //String btc_price = doc["ticker"]["price"].as<String>();      //Store crypto price and update date in local variables
  //String btc_change = doc["ticker"]["change"].as<String>();
  ...
  printCenter("BTC", 0, 0);                                                         //Display the comparison header

  display.setTextSize(3);
  printCenter("$" + String(BTCUSDPrice.toInt()), 0, 20);                                                //Display the current price
